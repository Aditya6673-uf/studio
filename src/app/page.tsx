...
export default function Dashboard() {
  ...
  return (
    <>
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <Card>
            <CardHeader className="flex-row items-center justify-between">
              ...
              <Button size="sm" onClick={() => setIsLendingDialogOpen(true)}>
                  ...
                  {lendings.length > 0 ? (
                    lendings.map(lending => (
                      <TableRow key={lending.id}>
                        <TableCell>
                          <div className="font-medium">{lending.personName}</div>
                          <div className="text-sm text-muted-foreground">{format(new Date(lending.dateLent), 'dd MMM, yyyy')}</div>
                        </TableCell>
                        <TableCell>
                          <Badge variant={lending.status === 'Paid' ? 'default' : 'secondary'} className={lending.status === 'Paid' ? 'bg-green-100 text-green-800' : ''}>
                            {lending.status}
                          </Badge>
                        </TableCell>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    This will create an income transaction for ₹{lending.amount.toLocaleString('en-IN')}. This action cannot be undone.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                  <AlertDialogCancel>Cancel</AlertDialogCancel>
                                  <AlertDialogAction onClick={() => updateLendingStatus(lending.id, 'Paid')}>
                                    Confirm
                                  </AlertDialogAction>
                                </AlertDialogFooter>
                              </AlertDialogContent>
      ...
      />
      <AddLendingDialog 
        isOpen={isLendingDialogOpen}
        setIsOpen={setIsLendingDialogOpen}
